      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground text-base sm:text-lg max-w-2xl mx-auto px-2 sm:px-0">
            Nossa jornada em números. Cada estatística representa horas de
            dedicação e paixão.
          </p>
        </motion.div>
          ...
          {stats.map((stat, index) => {
            ...
            return (
              <motion.div
                ...
                className="glass-card-hover p-4 sm:p-6 text-center group cursor-default"
              >
